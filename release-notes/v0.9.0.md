...
The full change log is available [here](https://github.com/akaswenwilk/godog/blob/master/CHANGELOG.md#090).
...
`GO111MODULE=on go get github.com/akaswenwilk/godog/cmd/godog@v0.9.0`
...
```
/go# go get github.com/akaswenwilk/godog/cmd/godog
...
[Example](https://github.com/akaswenwilk/godog/pull/240/files#diff-a5f59d298843b731ff8d2f9c670303ff).


### Hooks
The updated hooks can be found [here](https://github.com/akaswenwilk/godog/blob/b62eb13ee70c9f0f732b694b39bde9670051bac7/suite.go#L251).
...
### Formatter
The formatter interface have recieved some updates, the updated version can be found [here](https://github.com/akaswenwilk/godog/blob/b62eb13ee70c9f0f732b694b39bde9670051bac7/fmt.go#L100).
...
See [CHANGELOG.md](https://github.com/akaswenwilk/godog/blob/master/CHANGELOG.md#090).
